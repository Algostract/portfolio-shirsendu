...
<template>
  <NuxtLink :to="url" target="_blank"
    ...
    <NuxtImg :src="`/hackathons/${name}.webp`" :alt="name" loading="lazy" :width="96" :height="96"
      class="row-span-2 col-start-1 rounded-full w-full h-full bg-white dark:bg-black aspect-square" />
