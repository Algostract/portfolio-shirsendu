...
<template>
  <div
    class="flex justify-between mx-auto rounded-full pl-6 pr-[6px] py-[6px] w-full max-w-[328px] sm:max-w-[400px] md:max-w-[472px] h-fit align-middle bg-light-500 dark:bg-dark-500 focus-within:outline outline-offset-2 outline-2 outline-primary-400 transition-[outline] duration-300 shadow-[2px_2px_6px_0px_rgba(0,0,0,0.38)]">
    <ClientOnly>
